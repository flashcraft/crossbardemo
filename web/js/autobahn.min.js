...
(function(a){a(function(){function a(c,b,e,l){return d(c).then(b,e,l)}function d(a){return a instanceof c?a:k(a)?e(a):f(a)}function e(a){var c=m();try{a.then(function(a){c.resolve(a)},function(a){c.reject(a)},function(a){c.progress(a)})}catch(b){c.reject(b)}return c.promise}function c(a){this.then=a}function f(a){return new c(function(c){try{return d("function"==typeof c?c(a):a)}catch(b){return g(b)}})}function g(a){return new c(function(c,b){try{return d("function"==typeof b?b(a):g(a))}catch(e){return g(e)}})}
function m(){function a(c,b,d){return k(c,b,d)}function b(a){return n(d(a))}function e(a){return n(g(a))}function f(a){return q(a)}var s,v,h,k,q,n;s=new c(a);s={then:a,resolve:b,reject:e,progress:f,notify:f,promise:s,resolver:{resolve:b,reject:e,progress:f,notify:f}};v=[];h=[];k=function(a,c,b){var d,e;d=m();e="function"===typeof b?function(a){try{d.notify(b(a))}catch(c){d.notify(c)}}:function(a){d.notify(a)};v.push(function(b){b.then(a,c).then(d.resolve,d.reject,e)});h.push(e);return d.promise};
q=function(a){l(h,a);return a};n=function(a){k=a.then;n=d;q=p;l(v,a);h=v=u;return a};return s}function k(a){return a&&"function"===typeof a.then}function n(c,d,e,l,f){s(2,arguments);return a(c,function(c){function s(a){t(a)}function g(a){n(a)}var h,p,k,r,q,n,t,u,w,z;w=c.length>>>0;h=Math.max(0,Math.min(d,w));k=[];p=w-h+1;r=[];q=m();if(h){u=q.notify;t=function(a){r.push(a);--p||(n=t=v,q.reject(r))};n=function(a){k.push(a);--h||(n=t=v,q.resolve(k))};for(z=0;z<w;++z)z in c&&a(c[z],g,s,u)}else q.resolve(k);
return q.promise.then(e,l,f)})}function h(a,c,b,d){s(1,arguments);return q(a,p).then(c,b,d)}function q(c,d){return a(c,function(c){var e,l,f,s,h,g;f=l=c.length>>>0;e=[];g=m();if(f){s=function(c,l){a(c,d).then(function(a){e[l]=a;--f||g.resolve(e)},g.reject)};for(h=0;h<l;h++)h in c?s(c[h],h):--f}else g.resolve(e);return g.promise})}function l(a,c){for(var b,d=0;b=a[d++];)b(c)}function s(a,c){for(var b,d=c.length;d>a;)if(b=c[--d],null!=b&&"function"!=typeof b)throw Error("arg "+d+" must be a function");
}function v(){}function p(a){return a}var t,w,u;a.defer=m;a.resolve=d;a.reject=function(c){return a(c,g)};a.join=function(){return q(arguments,p)};a.all=h;a.map=q;a.reduce=function(c,d){var e=w.call(arguments,1);return a(c,function(c){var l;l=c.length;e[0]=function(c,e,f){return a(c,function(c){return a(e,function(a){return d(c,a,f,l)})})};return t.apply(c,e)})};a.any=function(a,c,b,d){return n(a,1,function(a){return c?c(a[0]):a[0]},b,d)};a.some=n;a.chain=function(c,d,e){var l=2<arguments.length;
return a(c,function(a){a=l?e:a;d.resolve(a);return a},function(a){d.reject(a);return g(a)},function(a){"function"===typeof d.notify&&d.notify(a);return a})};a.isPromise=k;c.prototype={always:function(a,c){return this.then(a,a,c)},otherwise:function(a){return this.then(u,a)},yield:function(a){return this.then(function(){return a})},spread:function(a){return this.then(function(c){return h(c,function(c){return a.apply(u,c)})})}};w=[].slice;t=[].reduce||function(a){var c,b,d,e,l;l=0;c=Object(this);e=
c.length>>>0;b=arguments;if(1>=b.length)for(;;){if(l in c){d=c[l++];break}if(++l>=e)throw new TypeError;}else d=b[1];for(;l<e;++l)l in c&&(d=a(d,c[l],l,c));return d};return a})})("function"==typeof define&&define.amd?define:function(a){"object"===typeof exports?module.exports=a():this.when=a()});var CryptoJS=CryptoJS||function(a,b){var d={},e=d.lib={},c=e.Base=function(){function a(){}return{extend:function(c){a.prototype=this;var b=new a;c&&b.mixIn(c);b.hasOwnProperty("init")||(b.init=function(){b.$super.init.apply(this,arguments)});b.init.prototype=b;b.$super=this;return b},create:function(){var a=this.extend();a.init.apply(a,arguments);return a},init:function(){},mixIn:function(a){for(var c in a)a.hasOwnProperty(c)&&(this[c]=a[c]);a.hasOwnProperty("toString")&&(this.toString=a.toString)},
clone:function(){return this.init.prototype.extend(this)}}}(),f=e.WordArray=c.extend({init:function(a,c){a=this.words=a||[];this.sigBytes=c!=b?c:4*a.length},toString:function(a){return(a||m).stringify(this)},concat:function(a){var c=this.words,b=a.words,d=this.sigBytes;a=a.sigBytes;this.clamp();if(d%4)for(var e=0;e<a;e++)c[d+e>>>2]|=(b[e>>>2]>>>24-8*(e%4)&255)<<24-8*((d+e)%4);else if(65535<b.length)for(e=0;e<a;e+=4)c[d+e>>>2]=b[e>>>2];else c.push.apply(c,b);this.sigBytes+=a;return this},clamp:function(){var c=
this.words,b=this.sigBytes;c[b>>>2]&=4294967295<<32-8*(b%4);c.length=a.ceil(b/4)},clone:function(){var a=c.clone.call(this);a.words=this.words.slice(0);return a},random:function(c){for(var b=[],d=0;d<c;d+=4)b.push(4294967296*a.random()|0);return new f.init(b,c)}}),g=d.enc={},m=g.Hex={stringify:function(a){var c=a.words;a=a.sigBytes;for(var b=[],d=0;d<a;d++){var e=c[d>>>2]>>>24-8*(d%4)&255;b.push((e>>>4).toString(16));b.push((e&15).toString(16))}return b.join("")},parse:function(a){for(var c=a.length,
b=[],d=0;d<c;d+=2)b[d>>>3]|=parseInt(a.substr(d,2),16)<<24-4*(d%8);return new f.init(b,c/2)}},k=g.Latin1={stringify:function(a){var c=a.words;a=a.sigBytes;for(var b=[],d=0;d<a;d++)b.push(String.fromCharCode(c[d>>>2]>>>24-8*(d%4)&255));return b.join("")},parse:function(a){for(var c=a.length,b=[],d=0;d<c;d++)b[d>>>2]|=(a.charCodeAt(d)&255)<<24-8*(d%4);return new f.init(b,c)}},n=g.Utf8={stringify:function(a){try{return decodeURIComponent(escape(k.stringify(a)))}catch(c){throw Error("Malformed UTF-8 data");
}},parse:function(a){return k.parse(unescape(encodeURIComponent(a)))}},h=e.BufferedBlockAlgorithm=c.extend({reset:function(){this._data=new f.init;this._nDataBytes=0},_append:function(a){"string"==typeof a&&(a=n.parse(a));this._data.concat(a);this._nDataBytes+=a.sigBytes},_process:function(c){var b=this._data,d=b.words,e=b.sigBytes,h=this.blockSize,g=e/(4*h),g=c?a.ceil(g):a.max((g|0)-this._minBufferSize,0);c=g*h;e=a.min(4*c,e);if(c){for(var k=0;k<c;k+=h)this._doProcessBlock(d,k);k=d.splice(0,c);b.sigBytes-=
...
b){return(new q.HMAC.init(a,b)).finalize(c)}}});var q=d.algo={};return d}(Math);(function(){var a=CryptoJS,b=a.lib.WordArray;a.enc.Base64={stringify:function(a){var b=a.words,c=a.sigBytes,f=this._map;a.clamp();a=[];for(var g=0;g<c;g+=3)for(var m=(b[g>>>2]>>>24-8*(g%4)&255)<<16|(b[g+1>>>2]>>>24-8*((g+1)%4)&255)<<8|b[g+2>>>2]>>>24-8*((g+2)%4)&255,k=0;4>k&&g+0.75*k<c;k++)a.push(f.charAt(m>>>6*(3-k)&63));if(b=f.charAt(64))for(;a.length%4;)a.push(b);return a.join("")},parse:function(a){var e=a.length,c=this._map,f=c.charAt(64);f&&(f=a.indexOf(f),-1!=f&&(e=f));for(var f=[],g=0,m=0;m<
e;m++)if(m%4){var k=c.indexOf(a.charAt(m-1))<<2*(m%4),n=c.indexOf(a.charAt(m))>>>6-2*(m%4);f[g>>>2]|=(k|n)<<24-8*(g%4);g++}return b.create(f,g)},_map:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/="}})();(function(){var a=CryptoJS,b=a.enc.Utf8;a.algo.HMAC=a.lib.Base.extend({init:function(a,e){a=this._hasher=new a.init;"string"==typeof e&&(e=b.parse(e));var c=a.blockSize,f=4*c;e.sigBytes>f&&(e=a.finalize(e));e.clamp();for(var g=this._oKey=e.clone(),m=this._iKey=e.clone(),k=g.words,n=m.words,h=0;h<c;h++)k[h]^=1549556828,n[h]^=909522486;g.sigBytes=m.sigBytes=f;this.reset()},reset:function(){var a=this._hasher;a.reset();a.update(this._iKey)},update:function(a){this._hasher.update(a);return this},finalize:function(a){var b=
this._hasher;a=b.finalize(a);b.reset();return b.finalize(this._oKey.clone().concat(a))}})})();(function(a){var b=CryptoJS,d=b.lib,e=d.WordArray,c=d.Hasher,d=b.algo,f=[],g=[];(function(){function c(b){for(var d=a.sqrt(b),e=2;e<=d;e++)if(!(b%e))return!1;return!0}function b(a){return 4294967296*(a-(a|0))|0}for(var d=2,e=0;64>e;)c(d)&&(8>e&&(f[e]=b(a.pow(d,0.5))),g[e]=b(a.pow(d,1/3)),e++),d++})();var m=[],d=d.SHA256=c.extend({_doReset:function(){this._hash=new e.init(f.slice(0))},_doProcessBlock:function(a,c){for(var b=this._hash.words,d=b[0],e=b[1],f=b[2],v=b[3],p=b[4],t=b[5],w=b[6],u=b[7],r=
0;64>r;r++){if(16>r)m[r]=a[c+r]|0;else{var y=m[r-15],x=m[r-2];m[r]=((y<<25|y>>>7)^(y<<14|y>>>18)^y>>>3)+m[r-7]+((x<<15|x>>>17)^(x<<13|x>>>19)^x>>>10)+m[r-16]}y=u+((p<<26|p>>>6)^(p<<21|p>>>11)^(p<<7|p>>>25))+(p&t^~p&w)+g[r]+m[r];x=((d<<30|d>>>2)^(d<<19|d>>>13)^(d<<10|d>>>22))+(d&e^d&f^e&f);u=w;w=t;t=p;p=v+y|0;v=f;f=e;e=d;d=y+x|0}b[0]=b[0]+d|0;b[1]=b[1]+e|0;b[2]=b[2]+f|0;b[3]=b[3]+v|0;b[4]=b[4]+p|0;b[5]=b[5]+t|0;b[6]=b[6]+w|0;b[7]=b[7]+u|0},_doFinalize:function(){var c=this._data,b=c.words,d=8*this._nDataBytes,
e=8*c.sigBytes;b[e>>>5]|=128<<24-e%32;b[(e+64>>>9<<4)+14]=a.floor(d/4294967296);b[(e+64>>>9<<4)+15]=d;c.sigBytes=4*b.length;this._process();return this._hash},clone:function(){var a=c.clone.call(this);a._hash=this._hash.clone();return a}});b.SHA256=c._createHelper(d);b.HmacSHA256=c._createHmacHelper(d)})(Math);(function(){var a=CryptoJS,b=a.lib,d=b.Base,e=b.WordArray,b=a.algo,c=b.HMAC,f=b.PBKDF2=d.extend({cfg:d.extend({keySize:4,hasher:b.SHA1,iterations:1}),init:function(a){this.cfg=this.cfg.extend(a)},compute:function(a,b){for(var d=this.cfg,f=c.create(d.hasher,a),h=e.create(),q=e.create([1]),l=h.words,s=q.words,v=d.keySize,d=d.iterations;l.length<v;){var p=f.update(b).finalize(q);f.reset();for(var t=p.words,w=t.length,u=p,r=1;r<d;r++){u=f.finalize(u);f.reset();for(var y=u.words,x=0;x<w;x++)t[x]^=y[x]}h.concat(p);
s[0]++}h.sigBytes=4*v;return h}});a.PBKDF2=function(a,c,b){return f.create(b).compute(a,c)}})();/*
...
(function(){Array.prototype.indexOf||(Array.prototype.indexOf=function(a){if(null===this)throw new TypeError;var b=Object(this),d=b.length>>>0;if(0===d)return-1;var e=0;0<arguments.length&&(e=Number(arguments[1]),e!==e?e=0:0!==e&&(Infinity!==e&&-Infinity!==e)&&(e=(0<e||-1)*Math.floor(Math.abs(e))));if(e>=d)return-1;for(e=0<=e?e:Math.max(d-Math.abs(e),0);e<d;e++)if(e in b&&b[e]===a)return e;return-1});Array.prototype.forEach||(Array.prototype.forEach=function(a,b){var d,e;if(null===this)throw new TypeError(" this is null or not defined");
var c=Object(this),f=c.length>>>0;if("[object Function]"!=={}.toString.call(a))throw new TypeError(a+" is not a function");b&&(d=b);for(e=0;e<f;){var g;e in c&&(g=c[e],a.call(d,g,e,c));e++}})})();ab._sliceUserAgent=function(a,b,d){var e=[],c=navigator.userAgent;a=c.indexOf(a);b=c.indexOf(b,a);0>b&&(b=c.length);d=c.slice(a,b).split(d);c=d[1].split(".");for(b=0;b<c.length;++b)e.push(parseInt(c[b],10));return{name:d[0],version:e}};
...
}c._websocket.onmessage=function(a){ab._debugws&&(c._rxcnt+=1,console.group("WS Receive"),console.info(c._wsuri+"  ["+c._session_id+"]"),console.log(c._rxcnt),console.log(a.data),console.groupEnd());a=JSON.parse(a.data);if(a[1]in c._calls){if(a[0]===ab._MESSAGE_TYPEID_CALL_RESULT){var b=c._calls[a[1]],d=a[2];if(ab._debugrpc&&void 0!==b._ab_callobj){console.group("WAMP Call",b._ab_callobj[2]);console.timeEnd(b._ab_tid);console.group("Arguments");for(var e=3;e<b._ab_callobj.length;e+=1){var n=b._ab_callobj[e];
if(void 0!==n)console.log(n);else break}console.groupEnd();console.group("Result");console.log(d);console.groupEnd();console.groupEnd()}b.resolve(d)}else if(a[0]===ab._MESSAGE_TYPEID_CALL_ERROR){b=c._calls[a[1]];d=a[2];e=a[3];n=a[4];if(ab._debugrpc&&void 0!==b._ab_callobj){console.group("WAMP Call",b._ab_callobj[2]);console.timeEnd(b._ab_tid);console.group("Arguments");for(var h=3;h<b._ab_callobj.length;h+=1){var q=b._ab_callobj[h];if(void 0!==q)console.log(q);else break}console.groupEnd();console.group("Error");
console.log(d);console.log(e);void 0!==n&&console.log(n);console.groupEnd();console.groupEnd()}void 0!==n?b.reject({uri:d,desc:e,detail:n}):b.reject({uri:d,desc:e})}delete c._calls[a[1]]}else if(a[0]===ab._MESSAGE_TYPEID_EVENT){if(b=c._prefixes.resolve(a[1],!0),b in c._subscriptions){var l=a[1],s=a[2];ab._debugpubsub&&(console.group("WAMP Event"),console.info(c._wsuri+"  ["+c._session_id+"]"),console.log(l),console.log(s),console.groupEnd());c._subscriptions[b].forEach(function(a){a(l,s)})}}else if(a[0]===
...
typeof c._websocket.protocol)ab._debugws&&(console.group("WS Warning"),console.info(c._wsuri),console.log("WebSocket object has no protocol attribute: WAMP subprotocol check skipped!"),console.groupEnd());else if(c._options&&c._options.skipSubprotocolCheck)ab._debugws&&(console.group("WS Warning"),console.info(c._wsuri),console.log("Server does not speak WAMP, but subprotocol check disabled by option!"),console.log(c._websocket.protocol),console.groupEnd());else throw c._websocket.close(1E3,"server does not speak WAMP"),
"server does not speak WAMP (but '"+c._websocket.protocol+"' !)";ab._debugws&&(console.group("WAMP Connect"),console.info(c._wsuri),console.log(c._websocket.protocol),console.groupEnd());c._websocket_connected=!0};c._websocket.onerror=function(a){};c._websocket.onclose=function(a){ab._debugws&&(c._websocket_connected?console.log("Autobahn connection to "+c._wsuri+" lost (code "+a.code+", reason '"+a.reason+"', wasClean "+a.wasClean+")."):console.log("Autobahn could not connect to "+c._wsuri+" (code "+
a.code+", reason '"+a.reason+"', wasClean "+a.wasClean+")."));void 0!==c._websocket_onclose&&(c._websocket_connected?a.wasClean?c._websocket_onclose(ab.CONNECTION_CLOSED,"WS-"+a.code+": "+a.reason):c._websocket_onclose(ab.CONNECTION_LOST):c._websocket_onclose(ab.CONNECTION_UNREACHABLE));c._websocket_connected=!1;c._wsuri=null;c._websocket_onopen=null;c._websocket_onclose=null;c._websocket=null}};
