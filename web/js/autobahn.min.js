...
a.all=p;a.map=function(a,c){return n(a,c)};a.reduce=function(c,b){var e=B(q,arguments,1);return a(c,function(c){var h;h=c.length;e[0]=function(c,e,f){return a(c,function(c){return a(e,function(a){return b(c,a,f,h)})})};return t.apply(c,e)})};a.settle=function(a){return n(a,k,u)};a.any=function(a,c,b,d){return h(a,1,function(a){return c?c(a[0]):a[0]},b,d)};a.some=h;a.isPromise=function(a){return a&&"function"===typeof a.then};e.prototype={otherwise:function(a){return this.then(v,a)},ensure:function(a){function b(){return c(a())}
...
C=y.call;B=y.bind?C.bind(C):function(a,c){return a.apply(c,q.call(arguments,2))};y=[];q=y.slice;t=y.reduce||function(a){var c,b,d,e,h;h=0;c=Object(this);e=c.length>>>0;b=arguments;if(1>=b.length)for(;;){if(h in c){d=c[h++];break}if(++h>=e)throw new TypeError;}else d=b[1];for(;h<e;++h)h in c&&(d=a(d,c[h],h,c));return d};return a})})("function"===typeof define&&define.amd?define:function(a){module.exports=a()},this);var CryptoJS=CryptoJS||function(a,b){var d={},e=d.lib={},c=e.Base=function(){function a(){}return{extend:function(c){a.prototype=this;var b=new a;c&&b.mixIn(c);b.hasOwnProperty("init")||(b.init=function(){b.$super.init.apply(this,arguments)});b.init.prototype=b;b.$super=this;return b},create:function(){var a=this.extend();a.init.apply(a,arguments);return a},init:function(){},mixIn:function(a){for(var c in a)a.hasOwnProperty(c)&&(this[c]=a[c]);a.hasOwnProperty("toString")&&(this.toString=a.toString)},
