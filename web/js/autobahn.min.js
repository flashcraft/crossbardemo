...
(function(a,b){a(function(){function a(b,d,e,h){return c(b).then(d,e,h)}function e(a,b){this.then=a;this.inspect=b}function c(a){return f(function(b){b(a)})}function f(a){return g(a,A.PromiseStatus&&A.PromiseStatus())}function g(a,b){function c(a){n&&(p=j(a),r(n,p),n=v,b&&p.then(function(){b.fulfilled()},function(a){b.rejected(a)}))}function d(a){c(m(a))}function h(a){n&&r(n,i(a))}var f,p,n=[];f=new e(function(a,c,d){return g(function(b,e,h){function f(s){s.then(a,c,d).then(b,e,h)}n?n.push(f):w(function(){f(p)})},
b&&b.observed())},function(){return p?p.inspect():{state:"pending"}});try{a(c,d,h)}catch(k){d(k)}return f}function j(a){return a instanceof e?a:!(a===Object(a)&&"then"in a)?l(a):f(function(b,c,d){w(function(){try{var e=a.then;"function"===typeof e?B(e,a,b,c,d):b(l(a))}catch(h){c(h)}})})}function l(a){var b=new e(function(c){try{return"function"==typeof c?j(c(a)):b}catch(d){return m(d)}},function(){return k(a)});return b}function m(a){var b=new e(function(c,d){try{return"function"==typeof d?j(d(a)):
b}catch(e){return m(e)}},function(){return u(a)});return b}function i(a){var b=new e(function(c,d,e){try{return"function"==typeof e?i(e(a)):b}catch(h){return i(h)}});return b}function r(a,b){w(function(){for(var c,d=0;c=a[d++];)c(b)})}function h(b,c,e,h,p){return a(b,function(b){return f(function(e,h,f){function p(a){j(a)}function n(a){l(a)}var g,k,s,i,l,j,m,r;m=b.length>>>0;g=Math.max(0,Math.min(c,m));s=[];k=m-g+1;i=[];if(g){j=function(a){i.push(a);--k||(l=j=o,h(i))};l=function(a){s.push(a);--g||
(l=j=o,e(s))};for(r=0;r<m;++r)r in b&&a(b[r],n,p,f)}else e(s)}).then(e,h,p)})}function p(a,b,c,d){return n(a,o).then(b,c,d)}function n(b,c,e){return a(b,function(b){return f(function(h,f,p){function n(b,s){a(b,c,e).then(function(a){g[s]=a;--k||h(g)},f,p)}var g,i,k,s;k=i=b.length>>>0;g=[];if(k)for(s=0;s<i;s++)s in b?n(b[s],s):--k;else h(g)})})}function k(a){return{state:"fulfilled",value:a}}function u(a){return{state:"rejected",reason:a}}function w(a){1===z.push(a)&&D(x)}function x(){for(var a,b=0;a=
z[b++];)a();z=[]}function o(a){return a}a.promise=f;a.resolve=c;a.reject=function(b){return a(b,m)};a.defer=function(){var a,b,d;a={promise:v,resolve:v,reject:v,notify:v,resolver:{resolve:v,reject:v,notify:v}};a.promise=b=f(function(e,h,f){a.resolve=a.resolver.resolve=function(a){if(d)return c(a);d=!0;e(a);return b};a.reject=a.resolver.reject=function(a){if(d)return c(m(a));d=!0;h(a);return b};a.notify=a.resolver.notify=function(a){f(a);return a}});return a};a.join=function(){return n(arguments,o)};
a.all=p;a.map=function(a,b){return n(a,b)};a.reduce=function(b,c){var e=B(q,arguments,1);return a(b,function(b){var h;h=b.length;e[0]=function(b,e,f){return a(b,function(b){return a(e,function(a){return c(b,a,f,h)})})};return t.apply(b,e)})};a.settle=function(a){return n(a,k,u)};a.any=function(a,b,c,d){return h(a,1,function(a){return b?b(a[0]):a[0]},c,d)};a.some=h;a.isPromise=function(a){return a&&"function"===typeof a.then};e.prototype={otherwise:function(a){return this.then(v,a)},ensure:function(a){function b(){return c(a())}
return this.then(b,b).yield(this)},yield:function(a){return this.then(function(){return a})},spread:function(a){return this.then(function(b){return p(b,function(b){return a.apply(v,b)})})},always:function(a,b){return this.then(a,a,b)}};var t,q,B,D,z,E,y,C,A,v;z=[];A="undefined"!=typeof console?console:a;E=b.setTimeout;D="function"===typeof setImmediate?setImmediate.bind(b):"object"===typeof process&&process.nextTick?process.nextTick:"object"===typeof vertx?vertx.runOnLoop:function(a){E(a,0)};y=Function.prototype;
C=y.call;B=y.bind?C.bind(C):function(a,b){return a.apply(b,q.call(arguments,2))};y=[];q=y.slice;t=y.reduce||function(a){var b,c,d,e,h;h=0;b=Object(this);e=b.length>>>0;c=arguments;if(1>=c.length)for(;;){if(h in b){d=b[h++];break}if(++h>=e)throw new TypeError;}else d=c[1];for(;h<e;++h)h in b&&(d=a(d,b[h],h,b));return d};return a})})("function"===typeof define&&define.amd?define:function(a){module.exports=a()},this);var CryptoJS=CryptoJS||function(a,b){var d={},e=d.lib={},c=e.Base=function(){function a(){}return{extend:function(b){a.prototype=this;var c=new a;b&&c.mixIn(b);c.hasOwnProperty("init")||(c.init=function(){c.$super.init.apply(this,arguments)});c.init.prototype=c;c.$super=this;return c},create:function(){var a=this.extend();a.init.apply(a,arguments);return a},init:function(){},mixIn:function(a){for(var b in a)a.hasOwnProperty(b)&&(this[b]=a[b]);a.hasOwnProperty("toString")&&(this.toString=a.toString)},
clone:function(){return this.init.prototype.extend(this)}}}(),f=e.WordArray=c.extend({init:function(a,c){a=this.words=a||[];this.sigBytes=c!=b?c:4*a.length},toString:function(a){return(a||j).stringify(this)},concat:function(a){var b=this.words,c=a.words,d=this.sigBytes,a=a.sigBytes;this.clamp();if(d%4)for(var e=0;e<a;e++)b[d+e>>>2]|=(c[e>>>2]>>>24-8*(e%4)&255)<<24-8*((d+e)%4);else if(65535<c.length)for(e=0;e<a;e+=4)b[d+e>>>2]=c[e>>>2];else b.push.apply(b,c);this.sigBytes+=a;return this},clamp:function(){var b=
this.words,c=this.sigBytes;b[c>>>2]&=4294967295<<32-8*(c%4);b.length=a.ceil(c/4)},clone:function(){var a=c.clone.call(this);a.words=this.words.slice(0);return a},random:function(b){for(var c=[],d=0;d<b;d+=4)c.push(4294967296*a.random()|0);return new f.init(c,b)}}),g=d.enc={},j=g.Hex={stringify:function(a){for(var b=a.words,a=a.sigBytes,c=[],d=0;d<a;d++){var e=b[d>>>2]>>>24-8*(d%4)&255;c.push((e>>>4).toString(16));c.push((e&15).toString(16))}return c.join("")},parse:function(a){for(var b=a.length,
c=[],d=0;d<b;d+=2)c[d>>>3]|=parseInt(a.substr(d,2),16)<<24-4*(d%8);return new f.init(c,b/2)}},l=g.Latin1={stringify:function(a){for(var b=a.words,a=a.sigBytes,c=[],d=0;d<a;d++)c.push(String.fromCharCode(b[d>>>2]>>>24-8*(d%4)&255));return c.join("")},parse:function(a){for(var b=a.length,c=[],d=0;d<b;d++)c[d>>>2]|=(a.charCodeAt(d)&255)<<24-8*(d%4);return new f.init(c,b)}},m=g.Utf8={stringify:function(a){try{return decodeURIComponent(escape(l.stringify(a)))}catch(b){throw Error("Malformed UTF-8 data");
}},parse:function(a){return l.parse(unescape(encodeURIComponent(a)))}},i=e.BufferedBlockAlgorithm=c.extend({reset:function(){this._data=new f.init;this._nDataBytes=0},_append:function(a){"string"==typeof a&&(a=m.parse(a));this._data.concat(a);this._nDataBytes+=a.sigBytes},_process:function(b){var c=this._data,d=c.words,e=c.sigBytes,g=this.blockSize,i=e/(4*g),i=b?a.ceil(i):a.max((i|0)-this._minBufferSize,0),b=i*g,e=a.min(4*b,e);if(b){for(var l=0;l<b;l+=g)this._doProcessBlock(d,l);l=d.splice(0,b);c.sigBytes-=
...
this._hasher,a=b.finalize(a);b.reset();return b.finalize(this._oKey.clone().concat(a))}})})();(function(a){var b=CryptoJS,d=b.lib,e=d.WordArray,c=d.Hasher,d=b.algo,f=[],g=[];(function(){function b(c){for(var d=a.sqrt(c),e=2;e<=d;e++)if(!(c%e))return!1;return!0}function c(a){return 4294967296*(a-(a|0))|0}for(var d=2,e=0;64>e;)b(d)&&(8>e&&(f[e]=c(a.pow(d,0.5))),g[e]=c(a.pow(d,1/3)),e++),d++})();var j=[],d=d.SHA256=c.extend({_doReset:function(){this._hash=new e.init(f.slice(0))},_doProcessBlock:function(a,b){for(var c=this._hash.words,d=c[0],e=c[1],f=c[2],n=c[3],k=c[4],u=c[5],w=c[6],x=c[7],o=
0;64>o;o++){if(16>o)j[o]=a[b+o]|0;else{var t=j[o-15],q=j[o-2];j[o]=((t<<25|t>>>7)^(t<<14|t>>>18)^t>>>3)+j[o-7]+((q<<15|q>>>17)^(q<<13|q>>>19)^q>>>10)+j[o-16]}t=x+((k<<26|k>>>6)^(k<<21|k>>>11)^(k<<7|k>>>25))+(k&u^~k&w)+g[o]+j[o];q=((d<<30|d>>>2)^(d<<19|d>>>13)^(d<<10|d>>>22))+(d&e^d&f^e&f);x=w;w=u;u=k;k=n+t|0;n=f;f=e;e=d;d=t+q|0}c[0]=c[0]+d|0;c[1]=c[1]+e|0;c[2]=c[2]+f|0;c[3]=c[3]+n|0;c[4]=c[4]+k|0;c[5]=c[5]+u|0;c[6]=c[6]+w|0;c[7]=c[7]+x|0},_doFinalize:function(){var b=this._data,c=b.words,d=8*this._nDataBytes,
e=8*b.sigBytes;c[e>>>5]|=128<<24-e%32;c[(e+64>>>9<<4)+14]=a.floor(d/4294967296);c[(e+64>>>9<<4)+15]=d;b.sigBytes=4*c.length;this._process();return this._hash},clone:function(){var a=c.clone.call(this);a._hash=this._hash.clone();return a}});b.SHA256=c._createHelper(d);b.HmacSHA256=c._createHmacHelper(d)})(Math);(function(){var a=CryptoJS,b=a.lib,d=b.Base,e=b.WordArray,b=a.algo,c=b.HMAC,f=b.PBKDF2=d.extend({cfg:d.extend({keySize:4,hasher:b.SHA1,iterations:1}),init:function(a){this.cfg=this.cfg.extend(a)},compute:function(a,b){for(var d=this.cfg,f=c.create(d.hasher,a),i=e.create(),r=e.create([1]),h=i.words,p=r.words,n=d.keySize,d=d.iterations;h.length<n;){var k=f.update(b).finalize(r);f.reset();for(var u=k.words,w=u.length,x=k,o=1;o<d;o++){x=f.finalize(x);f.reset();for(var t=x.words,q=0;q<w;q++)u[q]^=t[q]}i.concat(k);
p[0]++}i.sigBytes=4*n;return i}});a.PBKDF2=function(a,b,c){return f.create(c).compute(a,b)}})();/*
 MIT License (c) 2011-2013 Copyright Tavendo GmbH. */
var AUTOBAHNJS_VERSION="0.7.7",AUTOBAHNJS_DEBUG=!1,ab=window.ab={};ab._version=AUTOBAHNJS_VERSION;
...
ab.Session.prototype.close=function(){this._websocket_connected&&this._websocket.close()};ab.Session.prototype.sessionid=function(){return this._session_id};ab.Session.prototype.wsuri=function(){return this._wsuri};ab.Session.prototype.log=function(){this._options.sessionIdent?console.group("WAMP session '"+this._options.sessionIdent+"' ["+this._session_id+"]"):console.group("WAMP session ["+this._session_id+"]");for(var a=0;a<arguments.length;++a)console.log(arguments[a]);console.groupEnd()};
...
"Connection unreachable - scheduled reconnect to occur in "+a.options.retryDelay/1E3+" second(s).",{delay:a.options.retryDelay,retries:a.retryCount,maxretries:a.options.maxRetries});c?(ab._debugconnect&&console.log("Connection unreachable - retrying stopped by app"),a.onHangup(ab.CONNECTION_RETRIES_EXCEEDED,"Number of connection retries exceeded.")):(ab._debugconnect&&console.log("Connection unreachable - retrying ("+a.retryCount+") .."),window.setTimeout(ab._connect,a.options.retryDelay,a))}else a.onHangup(ab.CONNECTION_RETRIES_EXCEEDED,
"Number of connection retries exceeded.");break;case ab.CONNECTION_LOST:a.retryCount+=1;if(a.retryCount<=a.options.maxRetries)(c=a.onHangup(ab.CONNECTION_LOST_SCHEDULED_RECONNECT,"Connection lost - scheduled reconnect to occur in "+a.options.retryDelay/1E3+" second(s).",{delay:a.options.retryDelay,retries:a.retryCount,maxretries:a.options.maxRetries}))?(ab._debugconnect&&console.log("Connection lost - retrying stopped by app"),a.onHangup(ab.CONNECTION_RETRIES_EXCEEDED,"Connection lost.")):(ab._debugconnect&&
console.log("Connection lost - retrying ("+a.retryCount+") .."),window.setTimeout(ab._connect,a.options.retryDelay,a));else a.onHangup(ab.CONNECTION_RETRIES_EXCEEDED,"Connection lost.");break;default:throw"unhandled close code in ab._connect";}},a.options)};
