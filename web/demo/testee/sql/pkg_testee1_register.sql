BEGIN
   ...
   webmq.export('pkg_testee1', 'echo_string1',  pkg_testee_common.URI_CASE || '3.1.2#1');
   webmq.export('pkg_testee1', 'echo_string2',  pkg_testee_common.URI_CASE || '3.1.2#2');
   webmq.export('pkg_testee1', 'echo_string3',  pkg_testee_common.URI_CASE || '3.1.2#3');
   webmq.export('pkg_testee1', 'echo_string4',  pkg_testee_common.URI_CASE || '3.1.2#4');
